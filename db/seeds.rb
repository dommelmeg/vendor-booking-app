...
##User2
bach = Event.create(user_id: 2, vendor_id: 2, event_name: 'Bachelorette Party', date: 'May 5, 2024', rating: 5, review: 'We danced all night, great band!', image_url: 'https://cdn0.weddingwire.com/article/1222/3_2/960/jpg/12221-bachelorette-alexes-lauren-photography.jpeg')
...
##User3
jpWedding = Event.create(user_id: 3, vendor_id: 5, event_name: 'Jim and Pam Wedding', date: 'October 8, 2023', rating: 2, review: 'The lead singer Kevin kept using less words...', image_url: 'https://i0.wp.com/marvelousgeeksmedia.com/wp-content/uploads/2022/01/image.jpeg?w=1000&ssl=1')

grand_opening = Event.create(user_id: 3, vendor_id: 6, event_name: 'Michael Scott Paper Company Ribbon Cutting', date: 'April 9, 2024', rating: 5, review: 'They had perfect pitch', image_url: 'https://imageservice.disco.peacocktv.com/uuid/b3dfab67-7166-3f4e-bbca-771564927edf/LAND_16_9?language=eng&territory=US&proposition=NBCUOTT&version=556d8283-22ac-322b-abac-a223fefbe048')

...
##User3
andyAngelaWedding = Event.create(user_id: 3, vendor_id: 5, event_name: 'Andy and Angela Wedding', date: 2023-11-11, rating: 2, review: 'The lead singer Kevin kept using less words...')
grandOpening = Event.create(user_id: 3, vendor_id: 6, event_name: 'Michael Scott Paper Company', date: 2024-02-02, rating: 5, review: 'They had perfect pitch')